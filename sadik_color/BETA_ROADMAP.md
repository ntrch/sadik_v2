...
- [x] **F4.3b** 24fps double-buffer playback — PSRAM back/front buffers (80KB SPIRAM); codec _apply_* decodes into back buffer + sets pending flag; clip player swaps back↔front at 24fps deadline and blits front to TFT; codec_is_idle() gate prevents back buffer overwrite while frame pending. Build: SUCCESS [session-A 2026-04-28].
