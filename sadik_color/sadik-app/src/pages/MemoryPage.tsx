  ...
  return (
    <div className="h-full overflow-y-auto p-6 page-transition">
      <div className="flex items-center gap-3 mb-5">
        <div className="w-10 h-10 rounded-xl bg-accent-yellow/20 ring-1 ring-accent-yellow/40 flex items-center justify-center">
          <Lightbulb className="text-accent-yellow" size={22} />
        </div>
        <div>
          <h1 className="text-xl font-bold text-text-primary">Düşünceler</h1>
          <p className="text-xs text-text-muted">Kopyaladıkların burada birikiyor. Fikirlerini nota, notları görevlere dönüştür.</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        {activeTab === 'brainstorm' && (
          <button
            onClick={openNewNote}
            className="ml-auto flex items-center gap-2 px-4 py-2.5 bg-accent-pink/20 hover:bg-accent-pink/30 text-accent-pink border border-accent-pink/40 text-sm font-medium rounded-[14px] transition-colors"
          >
