...
export default function VoiceAssistant() {
  ...
  const processAudio = useCallback(async (blob: Blob, signal: AbortSignal) => {
    ...
    try {
      ...
      // T9.5.4: V1 LLM+TTS pipeline kaldırıldı.
      // Voice V2 (Gemini Live) bu path'i replace ediyor.
      // TODO(V2): Gemini Live WebSocket entegrasyonu buraya gelecek.
      console.warn('[Voice] V1 voice-chat-stream path is removed (T9.5.4). Use Voice V2.');
      await handleDidntHear(signal);
